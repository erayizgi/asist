        ...
        try {
            ...
            */
            ...
            $result = [
                ...
                'data' => $data,
                'comments' => Forecast::select('tb_iddaa_tahminleri.*', 'tb_kullanicilar.kullaniciAdi', 'tb_kullanicilar.IMG', 'tb_kullanicilar.adSoyad')->join("tb_kullanicilar", "tb_kullanicilar.ID", "tb_iddaa_tahminleri.tahminci_id")->where(['mac_id' => $id, 'tahmin_durumu' => 1])->orderBy('created_at', 'DESC')->get(),
            ];
